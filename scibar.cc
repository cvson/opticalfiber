...
int main(int argc,char** argv) 
{
  ...
  SCIBARDetectorConstruction* detector = new SCIBARDetectorConstruction();
  runManager->SetUserInitialization(detector);
  // Physics list
  runManager->SetUserInitialization(new SCIBARPhysicsList(physName));
  // User action initialization
  runManager->SetUserInitialization(new SCIBARActionInitialization(detector));
