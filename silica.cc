...
int main(int argc,char** argv) 
{
  ...
  SILICADetectorConstruction* detector = new SILICADetectorConstruction();
  runManager->SetUserInitialization(detector);
  // Physics list
  //runManager->SetUserInitialization(new SILICAPhysicsList(physName));
    runManager->SetUserInitialization(new SILICAPhysicsList());
  // User action initialization
  runManager->SetUserInitialization(new SILICAActionInitialization(detector));
