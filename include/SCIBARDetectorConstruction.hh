...
// ********************************************************************
//
// $Id: SCIBARDetectorConstruction.hh 77487 2013-11-25 10:15:04Z gcosmo $
//
/// \file optical/wls/include/SCIBARDetectorConstruction.hh
/// \brief Definition of the SCIBARDetectorConstruction class
//

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

#ifndef SCIBARDetectorConstruction_h
#define SCIBARDetectorConstruction_h 1
...
class SCIBARMaterials;
class G4Material;

class SCIBARDetectorMessenger;

class SCIBARPhotonDetSD;

#include "G4VUserDetectorConstruction.hh"
#include "G4Cache.hh"

class SCIBARDetectorConstruction : public G4VUserDetectorConstruction
{
  public:

    SCIBARDetectorConstruction();
    virtual ~SCIBARDetectorConstruction();
    ...
    // Set Material Commands for World and SCIBARfiber
    void SetWorldMaterial         (G4String);
    void SetSCIBARFiberMaterial      (G4String);
    void SetCoupleMaterial        (G4String);

    void SetPhotonDetGeometry     (G4String);
    void SetNumberOfCladding      (G4int);        // Maximum 2 claddings

    void SetSCIBARLength             (G4double);     // Total length of SCIBAR fiber
    void SetSCIBARRadius             (G4double);
    ...
    G4double GetSCIBARFiberLength();
    G4double GetSCIBARFiberEnd();
    G4double GetSCIBARFiberRMax();
    G4double GetSurfaceRoughness();
    G4bool   IsPerfectFiber();

    G4double GetBarLength();
    G4double GetBarBase();
    G4double GetBarThick();//newadd
    G4double GetBarWidth();//newadd
  ...
  private:
    ...
    G4double           fSCIBARfiberRX;
    G4double           fSCIBARfiberRY;
    G4double           fSCIBARfiberZ;
    ...
    G4double fBarLength;
    G4double fBarBase;
    G4double fBarThick;//newadd
    G4double fBarWidth;//newadd
  ...
  private:
     ...
     SCIBARDetectorMessenger* fDetectorMessenger;
     G4Cache<SCIBARPhotonDetSD*> fmppcSD;
