...
// ********************************************************************
//
// $Id: SILICADetectorConstruction.hh 77487 2013-11-25 10:15:04Z gcosmo $
//
/// \file optical/wls/include/SILICADetectorConstruction.hh
/// \brief Definition of the SILICADetectorConstruction class
//

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

#ifndef SILICADetectorConstruction_h
#define SILICADetectorConstruction_h 1
...
class SILICAMaterials;
class G4Material;

class SILICADetectorMessenger;

class SILICAPhotonDetSD;

#include "G4VUserDetectorConstruction.hh"
#include "G4Cache.hh"

class SILICADetectorConstruction : public G4VUserDetectorConstruction
{
  public:

    SILICADetectorConstruction();
    virtual ~SILICADetectorConstruction();
    ...
    // Set Material Commands for World and SILICAfiber
    void SetWorldMaterial         (G4String);
    void SetSILICAFiberMaterial      (G4String);
    void SetCoupleMaterial        (G4String);

    void SetPhotonDetGeometry     (G4String);
    void SetNumberOfCladding      (G4int);        // Maximum 2 claddings

    void SetSILICALength             (G4double);     // Total length of SILICA fiber
    void SetSILICARadius             (G4double);
    ...
    G4double GetSILICAFiberLength();
    G4double GetSILICAFiberEnd();
    G4double GetSILICAFiberRMax();
  ...
  private:
    ...
    G4double           fSILICAfiberRX;
    G4double           fSILICAfiberRY;
    G4double           fSILICAfiberZ;
  ...
  private:
     ...
     SILICADetectorMessenger* fDetectorMessenger;
     G4Cache<SILICAPhotonDetSD*> fmppcSD;
