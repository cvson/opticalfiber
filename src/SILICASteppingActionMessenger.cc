...
// ********************************************************************
//
// $Id: SILICASteppingActionMessenger.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SILICASteppingActionMessenger.cc
/// \brief Implementation of the SILICASteppingActionMessenger class
//
//
...
SILICASteppingActionMessenger::
  SILICASteppingActionMessenger(SILICASteppingAction* steppingaction)
...
SILICASteppingActionMessenger::~SILICASteppingActionMessenger()
{
  delete fSteppingDir;
...
void SILICASteppingActionMessenger::SetNewValue(G4UIcommand* command,
                                             G4String newValue)
{
