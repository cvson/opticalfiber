...
// ********************************************************************
//
// $Id: SCIBARRunActionMessenger.cc 70603 2013-06-03 11:23:16Z gcosmo $
//
/// \file optical/wls/src/SCIBARRunActionMessenger.cc
/// \brief Implementation of the SCIBARRunActionMessenger class
//
//
#include "globals.hh"
...
SCIBARRunActionMessenger::SCIBARRunActionMessenger(SCIBARRunAction* runaction)
...
SCIBARRunActionMessenger::~SCIBARRunActionMessenger()
{
...
void SCIBARRunActionMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
