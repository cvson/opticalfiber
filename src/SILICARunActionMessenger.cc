...
// ********************************************************************
//
// $Id: SILICARunActionMessenger.cc 70603 2013-06-03 11:23:16Z gcosmo $
//
/// \file optical/wls/src/SILICARunActionMessenger.cc
/// \brief Implementation of the SILICARunActionMessenger class
//
//
#include "globals.hh"
...
SILICARunActionMessenger::SILICARunActionMessenger(SILICARunAction* runaction)
...
SILICARunActionMessenger::~SILICARunActionMessenger()
{
...
void SILICARunActionMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
