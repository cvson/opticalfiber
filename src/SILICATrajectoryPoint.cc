...
// ********************************************************************
//
// $Id: SILICATrajectoryPoint.cc 72065 2013-07-05 09:54:59Z gcosmo $
//
/// \file optical/wls/src/SILICATrajectoryPoint.cc
/// \brief Implementation of the SILICATrajectoryPoint class
//
//
...
G4ThreadLocal G4Allocator<SILICATrajectoryPoint>* SILICATrajPointAllocator=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SILICATrajectoryPoint::SILICATrajectoryPoint()
      : fTime(0.), fMomentum(0.,0.,0.),
        fStepStatus(fUndefined), fVolumeName("") { }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SILICATrajectoryPoint::SILICATrajectoryPoint(const G4Step* aStep)
...
SILICATrajectoryPoint::SILICATrajectoryPoint(const G4Track* aTrack)
...
SILICATrajectoryPoint::SILICATrajectoryPoint(const SILICATrajectoryPoint &right)
...
const std::map<G4String,G4AttDef>* SILICATrajectoryPoint::GetAttDefs() const
{
  G4bool isNew;
...
std::vector<G4AttValue>* SILICATrajectoryPoint::CreateAttValues() const
{
