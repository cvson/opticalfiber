...
// ********************************************************************
//
// $Id: SCIBAROpticalPhysics.cc 102356 2017-01-23 16:22:42Z gcosmo $
//
/// \file optical/wls/src/SCIBAROpticalPhysics.cc
/// \brief Implementation of the SCIBAROpticalPhysics class
//
...
SCIBAROpticalPhysics::SCIBAROpticalPhysics(G4bool toggle)
...
SCIBAROpticalPhysics::~SCIBAROpticalPhysics() { }

#include "G4OpticalPhoton.hh"

void SCIBAROpticalPhysics::ConstructParticle()
{
...
void SCIBAROpticalPhysics::ConstructProcess()
{
    G4cout << "SCIBAROpticalPhysics:: Add Optical Physics Processes"
           << G4endl;

  fSCIBARProcess = new G4OpWLS();
  ...
  if (!pManager) {
     ...
     G4Exception("SCIBAROpticalPhysics::ConstructProcess()","",
  ...
  fSCIBARProcess->UseTimeProfile("delta");
  //fSCIBARProcess->UseTimeProfile("exponential");

  pManager->AddDiscreteProcess(fSCIBARProcess);
...
void SCIBAROpticalPhysics::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
