...
// ********************************************************************
//
// $Id: SILICAPrimaryGeneratorMessenger.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SILICAPrimaryGeneratorMessenger.cc
/// \brief Implementation of the SILICAPrimaryGeneratorMessenger class
//
//
...
SILICAPrimaryGeneratorMessenger::
                   SILICAPrimaryGeneratorMessenger(SILICAPrimaryGeneratorAction* gun)
  : fAction(gun)
{
  fGunDir = new G4UIdirectory("/SILICA/gun/");
  fGunDir->SetGuidance("SILICAPrimaryGenerator control");

  fSetPolarizationCmd =
                 new G4UIcmdWithADoubleAndUnit("/SILICA/gun/optPhotonPolar",this);
  ...
  fSetDecayTimeConstantCmd =
           new G4UIcmdWithADoubleAndUnit("/SILICA/gun/setDecayTimeConstant",this);
...
SILICAPrimaryGeneratorMessenger::~SILICAPrimaryGeneratorMessenger()
{
  delete fGunDir;
...
void SILICAPrimaryGeneratorMessenger::
