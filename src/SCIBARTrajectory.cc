...
// ********************************************************************
//
// $Id: SCIBARTrajectory.cc 90240 2015-05-21 09:08:13Z gcosmo $
//
/// \file optical/wls/src/SCIBARTrajectory.cc
/// \brief Implementation of the SCIBARTrajectory class
//
//
#include "G4AttDef.hh"
...
#include "SCIBARTrajectoryPoint.hh"
...
G4ThreadLocal G4Allocator<SCIBARTrajectory>* SCIBARTrajectoryAllocator=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SCIBARTrajectory::SCIBARTrajectory()
...
SCIBARTrajectory::SCIBARTrajectory(const G4Track* aTrack)
{
    ...
    fpPointsContainer = new SCIBARTrajectoryPointContainer();
    // Following is for the first trajectory point
    fpPointsContainer->push_back(new SCIBARTrajectoryPoint(aTrack));
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SCIBARTrajectory::SCIBARTrajectory(SCIBARTrajectory & right) : G4VTrajectory()
{
    ...
    for(size_t i=0;i<right.fpPointsContainer->size();++i) {
        SCIBARTrajectoryPoint* rightPoint
            = (SCIBARTrajectoryPoint*)((*(right.fpPointsContainer))[i]);
        fpPointsContainer->push_back(new SCIBARTrajectoryPoint(*rightPoint));
    }
}
...
void SCIBARTrajectory::ShowTrajectory(std::ostream& os) const
{
...
void SCIBARTrajectory::AppendStep(const G4Step* aStep)
{
    fpPointsContainer->push_back(new SCIBARTrajectoryPoint(aStep));
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4ParticleDefinition* SCIBARTrajectory::GetParticleDefinition()
{
...
void SCIBARTrajectory::MergeTrajectory(G4VTrajectory* secondTrajectory)
{
    if(!secondTrajectory) return;

    SCIBARTrajectory* second = (SCIBARTrajectory*)secondTrajectory;
...
const std::map<G4String,G4AttDef>* SCIBARTrajectory::GetAttDefs() const
{
    G4bool isNew;
...
std::vector<G4AttValue>* SCIBARTrajectory::CreateAttValues() const
{
