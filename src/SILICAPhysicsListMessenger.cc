...
:pPhysicsList(pPhys)
{
  N06Dir = new G4UIdirectory("/SILICA/");
  N06Dir->SetGuidance("UI commands of this example");
  
  physDir = new G4UIdirectory("/SILICA/phys/");
  physDir->SetGuidance("PhysicsList control");
 
  verboseCmd = new G4UIcmdWithAnInteger("/SILICA/phys/verbose",this);  
  ...
  cerenkovCmd = new G4UIcmdWithAnInteger("/SILICA/phys/cerenkovMaxPhotons",this);  
