...
// ********************************************************************
//
// $Id: SILICAUserTrackInformation.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SILICAUserTrackInformation.cc
/// \brief Implementation of the SILICAUserTrackInformation class
//
//
#include "G4ios.hh"
...
SILICAUserTrackInformation::SILICAUserTrackInformation ()
{
   fStatus = undefined;
...
G4bool SILICAUserTrackInformation::AddStatusFlag(TrackStatus s)
