...
// ********************************************************************
//
// $Id: SCIBARTrajectoryPoint.cc 72065 2013-07-05 09:54:59Z gcosmo $
//
/// \file optical/wls/src/SCIBARTrajectoryPoint.cc
/// \brief Implementation of the SCIBARTrajectoryPoint class
//
//
...
G4ThreadLocal G4Allocator<SCIBARTrajectoryPoint>* SCIBARTrajPointAllocator=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SCIBARTrajectoryPoint::SCIBARTrajectoryPoint()
      : fTime(0.), fMomentum(0.,0.,0.),
        fStepStatus(fUndefined), fVolumeName("") { }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SCIBARTrajectoryPoint::SCIBARTrajectoryPoint(const G4Step* aStep)
...
SCIBARTrajectoryPoint::SCIBARTrajectoryPoint(const G4Track* aTrack)
...
SCIBARTrajectoryPoint::SCIBARTrajectoryPoint(const SCIBARTrajectoryPoint &right)
...
const std::map<G4String,G4AttDef>* SCIBARTrajectoryPoint::GetAttDefs() const
{
  G4bool isNew;
...
std::vector<G4AttValue>* SCIBARTrajectoryPoint::CreateAttValues() const
{
