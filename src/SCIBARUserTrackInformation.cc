...
// ********************************************************************
//
// $Id: SCIBARUserTrackInformation.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SCIBARUserTrackInformation.cc
/// \brief Implementation of the SCIBARUserTrackInformation class
//
//
#include "G4ios.hh"
...
SCIBARUserTrackInformation::SCIBARUserTrackInformation ()
{
   fStatus = undefined;
...
G4bool SCIBARUserTrackInformation::AddStatusFlag(TrackStatus s)
