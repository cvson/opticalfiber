...
// ********************************************************************
//
// $Id: SILICAPhysicsListMessenger.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SILICAPhysicsListMessenger.cc
/// \brief Implementation of the SILICAPhysicsListMessenger class
//
//
#include "globals.hh"
...
SILICAPhysicsListMessenger::SILICAPhysicsListMessenger(SILICAPhysicsList* pPhys)
  : fPhysicsList(pPhys)
{

    fDirectory = new G4UIdirectory("/SILICA/phys/");
    fDirectory->SetGuidance("SILICAPhysicsList control");
 
    fSetAbsorptionCMD = new G4UIcmdWithABool("/SILICA/setAbsorption", this);
    fSetAbsorptionCMD->SetGuidance("Turn on or off absorption process");
    fSetAbsorptionCMD->AvailableForStates(G4State_Idle);

    fVerboseCmd = new G4UIcmdWithAnInteger("/SILICA/phys/verbose",this);
    ...
    fCerenkovCmd =
                new G4UIcmdWithAnInteger("/SILICA/phys/cerenkovMaxPhotons",this);
    ...
    fGammaCutCMD = new G4UIcmdWithADoubleAndUnit("/SILICA/phys/gammaCut",this);
    ...
    fElectCutCMD = new G4UIcmdWithADoubleAndUnit("/SILICA/phys/electronCut",this);
    ...
    fPosCutCMD = new G4UIcmdWithADoubleAndUnit("/SILICA/phys/positronCut",this);
    ...
    fAllCutCMD = new G4UIcmdWithADoubleAndUnit("/SILICA/phys/allCuts",this);
    ...
    fStepMaxCMD = new G4UIcmdWithADoubleAndUnit("/SILICA/phys/stepMax",this);
    ...
    fClearPhysicsCMD =
                  new G4UIcmdWithoutParameter("/SILICA/phys/clearPhysics",this);
    fClearPhysicsCMD->SetGuidance("Clear the physics list");
    fClearPhysicsCMD->AvailableForStates(G4State_PreInit,G4State_Idle);

    fRemovePhysicsCMD = new G4UIcmdWithAString("/SILICA/phys/removePhysics",this);
    fRemovePhysicsCMD->
    ...
    fListCMD = new G4UIcmdWithoutParameter("/SILICA/phys/list",this);
...
SILICAPhysicsListMessenger::~SILICAPhysicsListMessenger()
{
    delete fVerboseCmd;
    delete fCerenkovCmd;
...
void SILICAPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
