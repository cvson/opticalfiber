...
// ********************************************************************
//
// $Id: SILICADetectorMessenger.cc 84595 2014-10-17 07:33:27Z gcosmo $
//
/// \file optical/wls/src/SILICADetectorMessenger.cc
/// \brief Implementation of the SILICADetectorMessenger class
//
//
...
SILICADetectorMessenger::SILICADetectorMessenger(SILICADetectorConstruction * det)
  : fDetector(det)
{
  fDetDir = new G4UIdirectory("/SILICA/");
  fDetDir->SetGuidance(" Geometry Setup ");

  fSetPhotonDetGeometryCmd =
                      new G4UIcmdWithAString("/SILICA/setPhotonDetGeometry",this);
  fSetPhotonDetGeometryCmd->
  ...
  fSetNumOfCladLayersCmd =
                        new G4UIcmdWithAnInteger("/SILICA/setNumOfLayers", this);
  ...
  fSetSurfaceRoughnessCmd =
                      new G4UIcmdWithADouble("/SILICA/setSurfaceRoughness", this);
  fSetSurfaceRoughnessCmd->
                  SetGuidance("Set the roughness between Clad1 and SILICA Fiber");
  ...
  fSetXYRatioCmd = new G4UIcmdWithADouble("/SILICA/setXYRatio", this);
  ...
  fSetMirrorPolishCmd = new G4UIcmdWithADouble("/SILICA/setMirrorPolish", this);
  ...
  fSetMirrorReflectivityCmd =
                    new G4UIcmdWithADouble("/SILICA/setMirrorReflectivity", this);
  ...
  fSetPhotonDetPolishCmd =
                       new G4UIcmdWithADouble("/SILICA/setPhotonDetPolish", this);
  ...
  fSetPhotonDetReflectivityCmd =
                 new G4UIcmdWithADouble("/SILICA/setPhotonDetReflectivity", this);
  fSetPhotonDetReflectivityCmd->
  ...
  fSetSILICALengthCmd = new G4UIcmdWithADoubleAndUnit("/SILICA/setSILICALength",this);
  fSetSILICALengthCmd->SetGuidance("Set the half length of the SILICA fiber");
  fSetSILICALengthCmd->SetParameterName("length",false);
  fSetSILICALengthCmd->SetRange("length>0.");
  fSetSILICALengthCmd->SetUnitCategory("Length");
  fSetSILICALengthCmd->SetDefaultUnit("mm");
  fSetSILICALengthCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
  fSetSILICALengthCmd->SetToBeBroadcasted(false);

  fSetSILICARadiusCmd = new G4UIcmdWithADoubleAndUnit("/SILICA/setSILICARadius",this);
  fSetSILICARadiusCmd->SetGuidance("Set the radius of the SILICA fiber");
  fSetSILICARadiusCmd->SetParameterName("radius",false);
  fSetSILICARadiusCmd->SetRange("radius>0.");
  fSetSILICARadiusCmd->SetUnitCategory("Length");
  fSetSILICARadiusCmd->SetDefaultUnit("mm");
  fSetSILICARadiusCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
  fSetSILICARadiusCmd->SetToBeBroadcasted(false);

  fSetClad1RadiusCmd =
                   new G4UIcmdWithADoubleAndUnit("/SILICA/setClad1Radius",this);
  ...
  fSetClad2RadiusCmd =
                   new G4UIcmdWithADoubleAndUnit("/SILICA/setClad2Radius",this);
  ...
  fSetPhotonDetHalfLengthCmd =
             new G4UIcmdWithADoubleAndUnit("/SILICA/setPhotonDetHalfLength",this);
  fSetPhotonDetHalfLengthCmd->
  ...
  fSetGapCmd = new G4UIcmdWithADoubleAndUnit("/SILICA/setGap",this);
  ...
  fSetPhotonDetAlignmentCmd =
                       new G4UIcmdWithADoubleAndUnit("/SILICA/setAlignment",this);
  fSetPhotonDetAlignmentCmd->
  ...
  fSetMirrorCmd = new G4UIcmdWithABool("/SILICA/setMirror", this);
  ...
  fSetBarLengthCmd = new G4UIcmdWithADoubleAndUnit("/SILICA/setBarLength",this);
  ...
  fSetBarBaseCmd = new G4UIcmdWithADoubleAndUnit("/SILICA/setBarBase",this);
  ...
  fSetHoleRadiusCmd = new G4UIcmdWithADoubleAndUnit("/SILICA/setHoleRadius",this);
  ...
  fSetCoatingThicknessCmd =
               new G4UIcmdWithADoubleAndUnit("/SILICA/setCoatingThickness",this);
  fSetCoatingThicknessCmd->
  ...
  fSetCoatingRadiusCmd =
                new G4UIcmdWithADoubleAndUnit("/SILICA/setCoatingRadius",this);
  fSetCoatingRadiusCmd->
...
SILICADetectorMessenger::~SILICADetectorMessenger()
{
  delete fDetDir;

  delete fSetPhotonDetGeometryCmd;
  delete fSetNumOfCladLayersCmd;
  delete fSetSILICALengthCmd;
  delete fSetSILICARadiusCmd;
...
void SILICADetectorMessenger::SetNewValue(G4UIcommand* command,G4String val)
{
  ...
  else if( command == fSetSILICALengthCmd ) {
 
    fDetector->SetSILICALength(G4UIcmdWithADoubleAndUnit::GetNewDoubleValue(val));
  }
  else if( command == fSetSILICARadiusCmd ) {
 
    fDetector->SetSILICARadius(G4UIcmdWithADoubleAndUnit::GetNewDoubleValue(val));
  }
