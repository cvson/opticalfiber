...
// ********************************************************************
//
// $Id: SCIBARPhysicsList.cc 102356 2017-01-23 16:22:42Z gcosmo $
//
/// \file optical/wls/src/SCIBARPhysicsList.cc
/// \brief Implementation of the SCIBARPhysicsList class
//
//
#include "SCIBARPhysicsList.hh"
#include "SCIBARPhysicsListMessenger.hh"

#include "SCIBARExtraPhysics.hh"
#include "SCIBAROpticalPhysics.hh"
...
SCIBARPhysicsList::SCIBARPhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
//       if(!phys)G4Exception("SCIBARPhysicsList::SCIBARPhysicsList","InvalidSetup",
//                            FatalException,"PhysicsList does not exist");
       fMessenger = new SCIBARPhysicsListMessenger(this);
//    }
    ...
    fPhysicsVector->push_back(new SCIBARExtraPhysics());
    fPhysicsVector->push_back(fOpticalPhysics =
                                        new SCIBAROpticalPhysics(fAbsorptionOn));

    fPhysicsVector->push_back(new G4RadioactiveDecayPhysics());

    fStepMaxProcess = new SCIBARStepMax();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SCIBARPhysicsList::~SCIBARPhysicsList()
{
    delete fMessenger;
...
void SCIBARPhysicsList::ClearPhysics()
{
...
void SCIBARPhysicsList::ConstructParticle()
{
...
void SCIBARPhysicsList::ConstructProcess()
{
...
void SCIBARPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
    ...
    if (!success) {
       ...
       G4Exception("example SCIBARPhysicsList::RemoveFromPhysicsList()",
       "ExamSCIBARPhysicsList01",FatalException,message);
    }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void SCIBARPhysicsList::SetAbsorption(G4bool toggle)
{
       fAbsorptionOn = toggle;
       RemoveFromPhysicsList("Optical");
       fPhysicsVector->
                    push_back(fOpticalPhysics = new SCIBAROpticalPhysics(toggle));
       fOpticalPhysics->ConstructProcess();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void SCIBARPhysicsList::SetCuts()
{
    if (verboseLevel >0) {
        G4cout << "SCIBARPhysicsList::SetCuts:";
...
void SCIBARPhysicsList::SetCutForGamma(G4double cut)
{
    fCutForGamma = cut;
...
void SCIBARPhysicsList::SetCutForElectron(G4double cut)
{
    fCutForElectron = cut;
...
void SCIBARPhysicsList::SetCutForPositron(G4double cut)
{
    fCutForPositron = cut;
...
void SCIBARPhysicsList::SetStepMax(G4double step)
{
...
SCIBARStepMax* SCIBARPhysicsList::GetStepMaxProcess()
{
...
void SCIBARPhysicsList::AddStepMax()
{
...
void SCIBARPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void SCIBARPhysicsList::SetVerbose(G4int verbose)
{
