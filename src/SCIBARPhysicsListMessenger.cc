...
// ********************************************************************
//
// $Id: SCIBARPhysicsListMessenger.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SCIBARPhysicsListMessenger.cc
/// \brief Implementation of the SCIBARPhysicsListMessenger class
//
//
#include "globals.hh"
...
SCIBARPhysicsListMessenger::SCIBARPhysicsListMessenger(SCIBARPhysicsList* pPhys)
  : fPhysicsList(pPhys)
{

    fDirectory = new G4UIdirectory("/SCIBAR/phys/");
    fDirectory->SetGuidance("SCIBARPhysicsList control");
 
    fSetAbsorptionCMD = new G4UIcmdWithABool("/SCIBAR/setAbsorption", this);
    fSetAbsorptionCMD->SetGuidance("Turn on or off absorption process");
    fSetAbsorptionCMD->AvailableForStates(G4State_Idle);

    fVerboseCmd = new G4UIcmdWithAnInteger("/SCIBAR/phys/verbose",this);
    ...
    fCerenkovCmd =
                new G4UIcmdWithAnInteger("/SCIBAR/phys/cerenkovMaxPhotons",this);
    ...
    fGammaCutCMD = new G4UIcmdWithADoubleAndUnit("/SCIBAR/phys/gammaCut",this);
    ...
    fElectCutCMD = new G4UIcmdWithADoubleAndUnit("/SCIBAR/phys/electronCut",this);
    ...
    fPosCutCMD = new G4UIcmdWithADoubleAndUnit("/SCIBAR/phys/positronCut",this);
    ...
    fAllCutCMD = new G4UIcmdWithADoubleAndUnit("/SCIBAR/phys/allCuts",this);
    ...
    fStepMaxCMD = new G4UIcmdWithADoubleAndUnit("/SCIBAR/phys/stepMax",this);
    ...
    fClearPhysicsCMD =
                  new G4UIcmdWithoutParameter("/SCIBAR/phys/clearPhysics",this);
    fClearPhysicsCMD->SetGuidance("Clear the physics list");
    fClearPhysicsCMD->AvailableForStates(G4State_PreInit,G4State_Idle);

    fRemovePhysicsCMD = new G4UIcmdWithAString("/SCIBAR/phys/removePhysics",this);
    fRemovePhysicsCMD->
    ...
    fListCMD = new G4UIcmdWithoutParameter("/SCIBAR/phys/list",this);
...
SCIBARPhysicsListMessenger::~SCIBARPhysicsListMessenger()
{
    delete fVerboseCmd;
    delete fCerenkovCmd;
...
void SCIBARPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
