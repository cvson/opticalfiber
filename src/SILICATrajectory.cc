...
// ********************************************************************
//
// $Id: SILICATrajectory.cc 90240 2015-05-21 09:08:13Z gcosmo $
//
/// \file optical/wls/src/SILICATrajectory.cc
/// \brief Implementation of the SILICATrajectory class
//
//
#include "G4AttDef.hh"
...
#include "SILICATrajectoryPoint.hh"
...
G4ThreadLocal G4Allocator<SILICATrajectory>* SILICATrajectoryAllocator=0;
...
SILICATrajectory::SILICATrajectory(const G4Track* aTrack)
{
    ...
    fpPointsContainer = new SILICATrajectoryPointContainer();
    // Following is for the first trajectory point
    fpPointsContainer->push_back(new SILICATrajectoryPoint(aTrack));
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SILICATrajectory::SILICATrajectory(SILICATrajectory & right) : G4VTrajectory()
{
    ...
    for(size_t i=0;i<right.fpPointsContainer->size();++i) {
        SILICATrajectoryPoint* rightPoint
            = (SILICATrajectoryPoint*)((*(right.fpPointsContainer))[i]);
        fpPointsContainer->push_back(new SILICATrajectoryPoint(*rightPoint));
    }
}
...
void SILICATrajectory::ShowTrajectory(std::ostream& os) const
{
...
void SILICATrajectory::AppendStep(const G4Step* aStep)
{
    fpPointsContainer->push_back(new SILICATrajectoryPoint(aStep));
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4ParticleDefinition* SILICATrajectory::GetParticleDefinition()
{
...
void SILICATrajectory::MergeTrajectory(G4VTrajectory* secondTrajectory)
{
    if(!secondTrajectory) return;

    SILICATrajectory* second = (SILICATrajectory*)secondTrajectory;
...
const std::map<G4String,G4AttDef>* SILICATrajectory::GetAttDefs() const
{
    G4bool isNew;
...
std::vector<G4AttValue>* SILICATrajectory::CreateAttValues() const
{
