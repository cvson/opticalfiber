...
// ********************************************************************
//
// $Id: SCIBARPhotonDetSD.cc 69561 2013-05-08 12:25:56Z gcosmo $
//
/// \file optical/wls/src/SCIBARPhotonDetSD.cc
/// \brief Implementation of the SCIBARPhotonDetSD class
//
//
...
SCIBARPhotonDetSD::SCIBARPhotonDetSD(G4String name)
...
SCIBARPhotonDetSD::~SCIBARPhotonDetSD() { }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void SCIBARPhotonDetSD::Initialize(G4HCofThisEvent* HCE)
{
  fPhotonDetHitCollection =
       new SCIBARPhotonDetHitsCollection(SensitiveDetectorName,collectionName[0]);
...
G4bool SCIBARPhotonDetSD::ProcessHits(G4Step* , G4TouchableHistory* )
{
  return false;
}
...
G4bool SCIBARPhotonDetSD::ProcessHits_constStep(const G4Step* aStep,
                                             G4TouchableHistory* )
